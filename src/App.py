...
def draw_status(screen, points:int=0, level:int=0, fontsize=20, start_at_height:int=0, width=20, game:Game=None):
    fontsize = int(fontsize * .8)
    status_text = f'Level: {level} Points: {points}'
...
def main(width=4, height=3, level=0):
    ...
    while True:
        ...
        draw_status(screen, points, level, BLOCKSIZE // 2, start_at_height=window_height - int(BLOCKSIZE*.9), width=window_width, game=game)
